    ...
    notifications: [
      {
        ...
        read: false,
        created_at: new Date(Number(now) - 60 * 60e3).toISOString(),
      },
      {
        id: 'n2',
        ...
        body: 'HUD Q4 draft',
        read: key === 'empty_org',
        created_at: new Date(Number(now) - 2 * 24 * 60 * 60e3).toISOString(),
      },
      {
        id: 'n3',
        ...
        read: true,
        created_at: new Date(Number(now) - 5 * 24 * 60 * 60e3).toISOString(),
      },
    ],
    fundraising: {
      goal: 250000,
