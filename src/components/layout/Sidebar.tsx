...
const navigationItems: NavigationItem[] = [
  ...
  // Fundraising/Donors/Campaigns/Grants/Events - Development team
  {
    id: 'fundraising',
    label: 'Development',
    href: '/fundraising',
  ...
  // Volunteers - Volunteer coordinators and leadership
  {
    id: 'volunteers',
    label: 'Volunteers',
    href: '/volunteers',
  ...
  // HR/Payroll - HR and leadership only
  {
    id: 'hr',
  ...
  // Reports/Billing - Leadership and financial roles
  {
    id: 'reports',
  ...
  // Governance/Board Meetings/eSign - Board and leadership
  {
    id: 'governance',
    label: 'Governance',
    href: '/governance',
